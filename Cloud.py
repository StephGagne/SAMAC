...
##############
    ...
    def turbhrz(self):
        ...
        MaxCA=2    # in degrees (maximum change in the combined angle (phi+theta))
        MinDist=20000       # minimum distance, in meters
        PtNo=25             # number of points from which to calculate the turbulence=stdev(updraft vel)
        Pts=5      # number of points taken in running statistics of angles
        Pts2=50     # number of points taken in running statistics of the combined angle
